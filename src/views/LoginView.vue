    ...
    <div class="content-register">
      ...
      <form>
        <div class="form-group">
          ...
          <input type="text" id="patientPhoneNumber" v-model="logigInfo.id" @blur="login" placeholder="请输入账号" />
        </div>
        <div class="form-group">
          <label for="patientPassword">密码：</label>
          <input type="password" id="patientPassword" v-model="logigInfo.password" @blur="login" placeholder="请输入密码" />
        </div>
